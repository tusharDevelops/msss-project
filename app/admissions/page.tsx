...
const admissionsJsonLd = {
  ...
  "@type": "WebPage",
  name: "Admissions - Apply for Educational Programs",
  description: "Apply for admission to 150+ educational programs through MSSS expert counseling services",
  url: "https://msssrewa.com/admissions",
  mainEntity: {
    "@type": "Service",
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: "https://msssrewa.com",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Admissions",
        item: "https://msssrewa.com/admissions",
      },
    ],
  },
}
...
export default function AdmissionsPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(admissionsJsonLd) }} />
      <LanguageProvider>
        <AdmissionsContent />
      </LanguageProvider>
    </>
    ...
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden border-b bg-white/60 backdrop-blur">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-10">
          ...
          <p className="text-slate-600 mt-2">{t("adm.desc")}</p>
        </div>
      </div>
        ...
        <form onSubmit={onSubmit} className="grid gap-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <Input id="phone" type="tel" value={data.phone} onChange={(e) => set("phone", e.target.value)} required />
            </div>
            <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <Textarea id="message" rows={5} value={data.message} onChange={(e) => set("message", e.target.value)} />
          </div>
